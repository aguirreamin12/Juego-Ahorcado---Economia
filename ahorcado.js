...
// Array de palabras
let palabras = [["Smith", "Apellido de pensador"], ["Capitalismo", "Sistema económico"], ["Trabajo", "Fuente de toda riqueza"], ["Capital", "El valor total que desembolsa el capitalista para adquirir los medios de producción y la fuerza de trabajo necesaria para poner en marcha el proceso de producción"], ["Liberalismo", "Doctrina que defiende la libertad del individuo y una intervención mínima del estado en la vida social y económica."]];
// Palabra a averiguar
let palabra = "";
// Nº aleatorio
let rand;
